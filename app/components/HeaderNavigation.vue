<template>
  <div class="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 p-5">
    <UContainer class="max-w-5xl">
      <!-- 顶部导航栏 - 玻璃拟态效果 -->
      <nav class="backdrop-blur-xl bg-white/70 border border-white/20 rounded-2xl shadow-2xl shadow-blue-100/50 mb-8 animate-fade-in">
        <div class="px-8 py-6">
          <!-- Logo和标题区域 -->
          <div class="flex items-center justify-between mb-6">
            <div class="flex items-center gap-4">
              ...
              <div>
                ...
                <p class="text-sm text-gray-500 font-light">探索无限可能</p>
              </div>
            </div>
          ...
          <div class="relative">
            ...
            <!-- 搜索输入框 - 现代设计 -->
            <div class="relative group">
              <div class="absolute -inset-0.5 bg-gradient-to-r from-blue-500 to-purple-600 rounded-2xl blur opacity-30 group-hover:opacity-50 transition duration-300"></div>
              <div class="relative flex items-center bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl shadow-gray-200/50 border border-white/60">
                <div class="pl-6 pr-3">
...
<style scoped>
  ...
  .search-input:focus {
    box-shadow: 0 0 0 4px rgba(59, 130, 246, 0.15), 0 10px 40px rgba(0, 0, 0, 0.1);
